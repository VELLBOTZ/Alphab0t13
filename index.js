...
let content = fs.readFileSync(`image/${IMG-20211228-WA0000.jpg}`)
const media = await alpha.prepareMessage(from, content, MessageType.image, { thumbnail:fs.readFileSync(`image/${IMG-20211228-WA0000.jpg}`)})
